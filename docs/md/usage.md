...
When creating memories, use these specific categories based on the type of content:
...
### 4. **COMPANY** - Company and customer information
Use for storing information about companies, customers, and sales projects. These memories are managed exclusively through the llm-mem MCP tool and should be consulted before reading files from the file system.

**Example:**
```json
{
  "title": "Acme Corporation - Customer Profile",
  "content": "# Acme Corporation\n\n**Company Type:** Enterprise Customer\n**Industry:** Manufacturing\n**Location:** Berlin, Germany\n\n**Contact Information:**\n- **Primary Contact:** Max Mustermann\n- **Email:** max.mustermann@acme-corp.de\n- **Phone:** +49 30 12345678\n\n**Business Relationship:**\n- **Status:** Active Customer\n- **Contract Start:** 2023-01-15\n- **Annual Revenue:** €500,000\n- **Payment Terms:** Net 30\n\n**Key Projects:**\n1. **Digital Transformation Initiative** (2023-Q1)\n   - Migration to cloud infrastructure\n   - Status: Completed\n\n2. **E-Commerce Platform** (2023-Q2)\n   - New online store implementation\n   - Status: In Progress\n\n**Notes:**\n- Prefers email communication\n- Technical decision maker: CTO Anna Schmidt\n- Budget approval required from CFO\n- Quarterly business reviews scheduled",
  "category": "COMPANY",
  "tags": ["customer", "enterprise", "manufacturing", "active"],
  "sources": []
}
```

**Important Notes:**
- Always search llm-mem first before reading company files from the file system
- When updating company information, ensure the memory is updated as well
- Company memories may not always have `sources` arrays as they represent business entities, not code
- **Frontmatter must be passed** when creating or updating COMPANY memories using the `template` parameter in the llm-mem MCP tool

### 5. **PERSON** - Personal contacts and relationships
Use for storing information about individuals, contacts, and personal relationships relevant to your work.

**Example:**
```json
{
  "title": "Anna Schmidt - Technical Contact",
  "content": "# Anna Schmidt\n\n**Role:** Chief Technology Officer\n**Company:** Acme Corporation\n**Location:** Berlin, Germany\n\n**Contact Information:**\n- **Email:** anna.schmidt@acme-corp.de\n- **Phone:** +49 30 12345679\n- **LinkedIn:** linkedin.com/in/annaschmidt\n\n**Background:**\n- **Experience:** 15+ years in enterprise software\n- **Expertise:** Cloud architecture, DevOps, Security\n- **Education:** M.Sc. Computer Science, TU Berlin\n\n**Communication Preferences:**\n- Prefers technical discussions via email\n- Available for calls: Tuesday-Thursday, 10:00-16:00 CET\n- Responds quickly to urgent technical issues\n\n**Working Relationship:**\n- Primary technical decision maker for Acme Corp\n- Very detail-oriented, appreciates thorough documentation\n- Values security and compliance considerations\n\n**Notes:**\n- Speaks German and English fluently\n- Active in open-source community\n- Regular attendee at Berlin Tech Meetups",
  "category": "PERSON",
  "tags": ["contact", "cto", "technical", "acme-corp"],
  "sources": []
}
```

**Important Notes:**
- **Frontmatter must be passed** when creating or updating PERSON memories using the `template` parameter in the llm-mem MCP tool
- Person memories may not always have `sources` arrays as they represent individuals, not code

### 6. **ENDEAVOUR** - Sub-projects and initiatives
Use for managing sub-projects, initiatives, and work streams. Endeavours are managed exclusively through the llm-mem MCP tool and have specific frontmatter fields that must be maintained.

**Important:** Endeavours are **only** managed in llm-mems, not in the file system.

**Required Frontmatter Fields:**
- `status`: Current status of the endeavour (see status values below)
- `summary`: Brief summary that should be updated whenever changes are made

**Status Values:**
- `active` - Active endeavour, currently being worked on
- `on-hold` - Endeavour is paused, temporarily not being worked on
- `delegated` - Endeavour has been delegated to someone else
- `archived` - Endeavour is completed or archived
- `backlog` - Endeavour is in the backlog, not yet started

**Example:**
```json
{
  "title": "E-Commerce Platform Migration",
  "content": "# E-Commerce Platform Migration\n\n**Objective:** Migrate Acme Corporation's e-commerce platform to a modern cloud-based architecture.\n\n**Timeline:**\n- **Start Date:** 2023-04-01\n- **Target Completion:** 2023-09-30\n- **Current Phase:** Implementation\n\n**Key Milestones:**\n1. ✅ Requirements gathering (completed 2023-04-15)\n2. ✅ Architecture design (completed 2023-05-01)\n3. 🔄 Database migration (in progress, 60% complete)\n4. ⏳ Frontend implementation (pending)\n5. ⏳ Testing and QA (pending)\n6. ⏳ Production deployment (pending)\n\n**Team:**\n- **Project Lead:** Max Mustermann\n- **Technical Lead:** Anna Schmidt (Acme Corp)\n- **Developers:** 3 assigned\n\n**Resources:**\n- **Budget:** €200,000\n- **Infrastructure:** AWS Cloud\n- **Tools:** React, Node.js, PostgreSQL\n\n**Risks:**\n- Data migration complexity (mitigated with staged approach)\n- Timeline pressure (addressed with additional resources)\n\n**Current Status:** Active development phase, on track for Q3 completion.",
  "category": "ENDEAVOUR",
  "tags": ["migration", "e-commerce", "acme-corp", "cloud"],
  "sources": [],
  "template": {
    "status": "active",
    "summary": "Active migration project for Acme Corp's e-commerce platform, currently in implementation phase (60% database migration complete)"
  }
}
```

**Important Notes:**
- Always use the llm-mem MCP tool to create, read, update, or search for endeavours
- Update the `summary` field whenever making changes to an endeavour
- Maintain the `status` field accurately to reflect current state
- Endeavours do not have file system representations

### 7. **RAW** - Raw or unstructured data
Use for storing raw data, unstructured information, or content that doesn't fit into other categories. This category is useful for temporary storage, data dumps, or unstructured notes that may need processing later.

**Example:**
```json
{
  "title": "Meeting Notes - 2024-01-15 - Product Planning",
  "content": "# Meeting Notes - Product Planning Session\n\n**Date:** 2024-01-15\n**Participants:** Team Lead, Product Manager, 3 Developers\n**Duration:** 2 hours\n\n**Raw Notes:**\n\n- Discussed Q1 roadmap\n- New feature requests:\n  - User dashboard improvements\n  - API rate limiting\n  - Analytics integration\n- Technical debt items:\n  - Refactor authentication module\n  - Update dependencies\n  - Improve test coverage\n- Questions raised:\n  - How to handle migration?\n  - What about backward compatibility?\n  - Performance implications?\n\n**Action Items:**\n- [ ] Create tickets for new features\n- [ ] Prioritize technical debt\n- [ ] Schedule follow-up meeting\n\n**Next Steps:**\n- Review and structure these notes\n- Create proper documentation memories\n- Assign tasks to team members",
  "category": "RAW",
  "tags": ["meeting-notes", "raw", "unstructured"],
  "sources": []
}
```

**Use Cases:**
- Meeting notes before they're structured
- Data dumps that need processing
- Temporary information storage
- Unstructured research notes
- Content that will be refined into other categories later
...
- **COMPANY**: Store company and customer information (managed via llm-mem)
- **PERSON**: Store personal contacts and relationships
- **ENDEAVOUR**: Manage sub-projects and initiatives (managed via llm-mem, requires status and summary)
- **RAW**: Store unstructured data, temporary notes, or content to be processed later
...
1. **Always include specific source references** in the `sources` array (when applicable - COMPANY, PERSON, ENDEAVOUR, and RAW may not have sources)
2. **Use the appropriate category** (ADR, DOC, CTX, COMPANY, PERSON, ENDEAVOUR, RAW) for the type of content
3. **Be precise with line ranges** when documenting specific functions or classes (for DOC category)
4. **Link related memories** to create a knowledge graph
5. **Include code examples** in your documentation content (for DOC and CTX categories)
...
8. **For COMPANY memories:** Always search llm-mem first before reading company files from the file system
9. **For ENDEAVOUR memories:** Always use llm-mem MCP tools, maintain `status` and `summary` fields, update summary whenever making changes
10. **For RAW memories:** Consider refining into structured categories (DOC, CTX, etc.) when appropriate
